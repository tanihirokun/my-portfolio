...
export const Skill: VFC = memo(() => {
  ...
  return (
    <Flex
      ...
      w="100%"
      maxWidth="1000px"
      justifyContent={notSmall ? "space-between" : "center"}
      paddingTop={notSmall ? "20" : "14"}
      px="40px"
      paddingBottom={notSmall ? "20" : "14"}
    >
      {/* 粘り強さ */}
      <Flex direction="column" alignSelf="center" w="35vh">
        ...
        >
          美容師として長年過酷な環境で仕事をしてきました。どんなことがあっても前向きに目標に向かって進む力があります。
        </Text>
      </Flex>
      {/* 新しい技術への挑戦 */}
      <Flex direction="column" alignSelf="center" w="35vh">
        ...
        <Text
          ...
          color={isDark ? "gray.200" : "gray.600"}
        >
          より良いサービスの提供のために沢山の勉強をしています。モダンな技術には目がありません！Reactを極めたいです。
        </Text>
      </Flex>
      ...
      <Flex direction="column" alignSelf="center" w="35vh">
        ...
        <Text
          ...
          color={isDark ? "gray.200" : "gray.600"}
        >
          世の中の、全ての人から沢山のことを吸収していきたいです。沢山の知識を得て人間的に成長し、開発に活かしていきます。
        </Text>
      </Flex>
    </Flex>
  );
